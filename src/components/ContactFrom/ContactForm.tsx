...
if (validator.allValid()) {
  ...
  alert(
    "Thank you! Your business audit request has been submitted."
  );
    ...
    <div className="col-lg-12 col-md-12 mt-20">
      ...
      <div className="xb-input-field xb-select-field">
        ...
        >
          ...
          <option value="Premium Website Development">
          ...
          <option value="Digital Marketing & Advertising">
            Digital Marketing & Advertising
          </option>

          <option value="Business Registration Support">
            Business Registration Support
          </option>

          <option value="Barcode Registration">
            Barcode Registration
          </option>

          <option value="Startup Business Support">
            Startup Business Support
          </option>

          <option value="AI Automation & SaaS Infrastructure">
            AI Automation & SaaS Infrastructure
          </option>

          <option value="Business Growth Consultation">
