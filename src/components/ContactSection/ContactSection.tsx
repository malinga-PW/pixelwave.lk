            ...
            <div className="xb-content-wrap">
              <div className="sec-title contact-sec-title">
                ...
                <h2 className="title horizontal-shape">
                  ...
                  <img src={gifShape} alt="animated-shape" />
                ...
                >
                  PixelWave Total Solution helps businesses build premium
                  websites, automate workflows, strengthen branding, increase
                  visibility, and achieve long-term growth through AI + Human
                  expertise.
                </p>
              </div>
            ...
            <div className="xb-contact-form xb-border">
              <div className="form-heading text-center mb-30">
                ...
                <p className="sub-title">
                  Tell us about your business. Elena.AI and our team will review
                  your workflow and recommend practical growth opportunities.
                </p>
              </div>
              ...
              >
                <p>
                  <strong>Email:</strong>{" "}
                  <a href="mailto:hello@pixelwave.lk">hello@pixelwave.lk</a>
                </p>
                <p>
                  <strong>Phone:</strong>{" "}
                  <a href="tel:+94719739734">+94 71 973 973 4</a>
                </p>
                <p>
                  <strong>Location:</strong> Mulleriyawa, Sri Lanka
                </p>
              </div>
              ...
              >
                <a
                  href="[https://maps.app.goo.gl/R9puubMq9Wi93SsP8](https://maps.app.goo.gl/R9puubMq9Wi93SsP8)"
                  target="_blank"
              ...
              >
                <a
                  href="[https://wa.me/94719739734](https://wa.me/94719739734)"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="thm-btn"
                >
